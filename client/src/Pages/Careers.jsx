          ...
          <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
            <span className="text-green-500">
              <svg className="h-5 fill-current" viewBox="0 0 24 24">
                <path d="M12 4a4 4 0 014 4c0 2.21-1.79 4-4 4s-4-1.79-4-4a4 4 0 014-4m0 10c2.67 0 8 1.34 8 4v2H4v-2c0-2.66 5.33-4 8-4z"></path>
              </svg>
            </span>
          ...
          <div className="text-gray-700">
            <div className="grid md:grid-cols-2 text-sm">
              ...
              <div className="grid grid-cols-2">
                ...
                <div className="px-4 py-2">
                  {null ? "N/A" : job.job_min_salary}$ -{" "}
                  {null ? "N/A" : job.job_max_salary}$
                </div>
              </div>
              <div className="grid grid-cols-2">
              ...
              <div className="grid grid-cols-2">
                ...
                <div className="px-4 py-2">
                  <a
                    className="text-blue-800 hover:text-blue-500 hover:underline cursor-pointer font-bold text-sm "
